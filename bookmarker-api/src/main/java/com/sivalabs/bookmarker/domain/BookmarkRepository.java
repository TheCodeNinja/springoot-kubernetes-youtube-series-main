...
public interface BookmarkRepository extends JpaRepository<Bookmark, Long> {
    ...
    @Query("select new com.sivalabs.bookmarker.domain.BookmarkDTO(b.id, b.title, b.url, b.createdAt) from Bookmark b where lower(b.title) like lower(concat('%', :query, '%'))")
